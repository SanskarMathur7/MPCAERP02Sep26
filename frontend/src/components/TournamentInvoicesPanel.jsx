    ...
    return (
        <div className="border border-mpca-brass/40 bg-mpca-ivory p-5" data-testid="panel-tournament-invoices">
            <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
                ...
                <Link to={`/tournaments/${tournament.id}/finance/legacy?tab=officials`} className="text-[10px] font-semibold uppercase tracking-widest text-mpca-parchment bg-mpca-oxblood hover:bg-mpca-oxblood/90 px-3 py-2 inline-flex items-center gap-1.5" data-testid="ti-open-full-btn">
