...
export const PageEyebrow = ({ title, meta, rightAction, links = [] }) => (
    <div className="mb-8 flex items-center justify-between gap-6 flex-wrap">
        <div className="flex items-baseline gap-4 flex-wrap">
            <span className="text-[18px] uppercase tracking-[0.22em] font-bold" style={{ fontFamily: DL.fontMono, color: DL.ink }}>
                / {title}
            </span>
            {meta && (
                <span className="text-[15px] uppercase tracking-[0.22em] font-semibold" style={{ fontFamily: DL.fontMono, color: DL.ink2 }}>
                    {meta}
                </span>
            )}
            {links.map((l) => (
                <a
                    key={l.href}
                    href={l.href}
                    className="text-[15px] uppercase tracking-[0.22em] font-bold underline underline-offset-4"
